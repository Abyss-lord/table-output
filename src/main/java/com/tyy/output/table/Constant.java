...
public class Constant {
  ...
  public static final int TABLE_UPPER_BORDER_WITH_TITLE_COLUMN_SEPARATOR_IDX = 1;
  ...
  // ===== Title Line Bottom Border Indices =====
  public static final int TITLE_LINE_BORDER_LEFT_IDX = 18;
  public static final int TITLE_LINE_BORDER_MIDDLE_IDX = 19;
  public static final int TITLE_LINE_BORDER_COLUMN_SEPARATOR_IDX = 2;
  public static final int TITLE_LINE_BORDER_RIGHT_IDX = 21;

  // ===== Title Line Row Separator Indices =====
  public static final int TITLE_LINE_ROW_BORDER_LEFT_IDX = 18;
  public static final int TITLE_LINE_ROW_BORDER_MIDDLE_IDX = 19;
  public static final int TITLE_LINE_ROW_BORDER_COLUMN_SEPARATOR_IDX = 19;
  public static final int TITLE_LINE_ROW_BORDER_RIGHT_IDX = 21;
